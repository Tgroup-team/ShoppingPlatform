...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	import="web.entity.User" pageEncoding="UTF-8"%>
				...
				<div class="am-container header">
					...
					<ul class="message-r">
						...
						<div class="topMessage home">
							<div class="menu-hd">
								<a href="<%=request.getContextPath() %>" target="_top" class="h"><i
				...
				<div class="m-user">
					...
					<div class="m-userinfo">
						<div class="m-baseinfo">
							...
							</a> <em class="s-name">${sessionScope.user.vipName }<span
								class="vip1"></em>
...
<!-- 						<div class="m-right">
	...
	<div class="center">
		<div class="col-main">
			...
			<!--浮动框架-->
			<div class="main-wrap">
				<iframe width="1020px" height="700px" name="main"
					style="background-color: white;" src="page" scrolling="no"
					allowTransparency="true"
					<%=request.getAttribute("iframeUrl")!=null?"src='"+request.getAttribute("iframeUrl")+"'":"" %>></iframe>
			</div>
			...
			<div class="footer" style="margin-bottom: -24px;">
				...
				<div class="m-user">
					...
					<div class="m-userinfo" style="overflow: hidden;">
						<div class="footer-hd">
							<p>
								<span><a href="#">恒望科技</a></span> <b>|</b> <a href="#">商城首页</a>
								<b>|</b> <a href="#">支付宝</a> <b>|</b> <a href="#">物流信息</a> <b>|</b>
								<a href="#">微信</a> <b>|</b> <a href="#">联系我们</a> <a href="#"
									style="margin-left: 245px;">关于恒望</a> <a href="#">合作伙伴</a> <a
									href="#">联系我们</a> <a href="#">网站地图</a> <em>© 2015-2025
									Hengwang.com 版权所有</em>
							</p>
						</div>
					</div>
				</div>
		...
		<aside class="menu">
			<ul>
				<li class="person active"><a href="#">个人中心</a></li>
