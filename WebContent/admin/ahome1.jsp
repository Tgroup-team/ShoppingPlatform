				...
				<div class="am-container header">
					...
					<ul class="message-r">
						...
						<div class="  topMessage mini-cart">
							<div class="menu-hd">
								<a id="mc-menu-hd" href="shopcart2.jsp" target="_top"><i
	...
	<div class="center">
		<div class="col-main">
			...
			<div class="main-wrap" style="background-color: #ffffff;">
				<iframe width="1000" height="800" name="main" src="catagory1.jsp"
		...
		<aside class="menu">
			<ul>
				...
				<li class="person"><a href="#">产品类别管理</a>
					<ul>
						<li><a href="catagory1.jsp" target="main">产品类别</a></li>

					</ul></li>
				<li class="person"><a href="#">产品管理</a>
					<ul>
						<li><a href="product1.jsp" target="main">添加产品</a></li>

					</ul></li>
				<li class="person"><a href="#">订单管理</a>
					<ul>
						<li><a href="porder1.jsp" target="main">查看订单</a></li>
						<li><a href="return1.jsp" target="main">退货</a></li>
					</ul></li>
				<li class="person"><a href="#">社区管理</a>
					<ul>
						<li><a href="community1.jsp" target="main">团长审核</a></li>
						<li><a href="community2.jsp" target="main">添加社区</a></li>

					</ul></li>
				<li class="person"><a href="#">我的账户</a>
					<ul>

						<li><a href="baccounts1.jsp" target="main">余额账户</a></li>
