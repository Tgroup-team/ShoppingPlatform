		...
		<div class="hmtop">
			...
			<div class="am-container header">
				...
				<ul class="message-r">
						...
						<div class="menu-hd"><a href="register2.html" target="_top"><span>注册</span></a></div>
                                        </div>
                                    
                                    <div class="topMessage denglu">
						<div class="menu-hd"><a href="login2.html" target="_top"><span>登录</span></a></div>
                                        </div>
                                    
                                         <div class="topMessage my-shangcheng">
						<div class="menu-hd MyShangcheng"><a href="personalcenter2.html" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div>
					</div>
					...
					<div class="topMessage favorite1">
						<div class="menu-hd"><a href="login1.html" target="_top"><span>管理员中心</span></a></div>
                                        </div>
